...
if($arCurrentValues["EVENT_ET_MESSAGE_ID"]){
	...
	$arFilter = Array("TYPE_ID" => "CB_CALLBACK_FORM_EVENT", "ACTIVE" => "Y");
}
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"EVENT_ET_MESSAGE_ID" => Array(
			...
			"VALUES" => $arETEvent,
			"MULTIPLE"=>"N",
			"DEFAULT"=>"CB_CALLBACK_FORM_EVENT",
			"COLS"=>25,
			"PARENT" => "BASE",
			"REFRESH" => "Y",
		),
		"EVENT_MESSAGE_ID" => Array(
			...
			"TYPE"=>"LIST",
			"VALUES" => $arEvent,
			"DEFAULT"=>COption::GetOptionString('collected.callback','COLLECTED_CALLBACK_MODULE_INSTALL_MSG_ID'),
			"MULTIPLE"=>"N",
			"COLS"=>25,
			"PARENT" => "BASE",
		),
